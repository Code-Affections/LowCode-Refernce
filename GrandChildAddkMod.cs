...
namespace appMODEL
{
    ...
    public class GrandChildAddk
    {
        ...
        public List<GrandChildAddknormcombo> GrandChildAddknormcomboList { get; set; }
        //-----------------------------------------------------------------------------
        //END For normal combo
        //-----------------------------------------------------------------------------
        //public long GrandChildAddk_Type_ID { get; set; }
        public string GrandChildAddkTypeName { get; set; }
        public List<GrandChildAddkType> GrandChildAddkTypes { get; set; }   //for inner dropdown list within grid column

        public long Document_ID { get; set; }    //for Upload of a Document
        public string Risk_Level { get; set; }
        public long Risk_Level_ID { get; set; }
        public List<GrandChildAddkRiskLevelList> RiskTypess { get; set; }
    ...
    //----------------------------------------------------------------------------------------------------
    public class GrandChildAddknormcombo
    {
    ...
    /// List of Type
    /// </summary>
    public class GrandChildAddkType
    {
        //public long GrandChildAddk_Type_ID { get; set; }
        public string GrandChildAddkTypeName { get; set; }
    }
    ...
    /// </summary>
    public class GrandChildAddkRiskLevelList
    {
