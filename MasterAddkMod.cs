...
namespace appMODEL
{
    ...
    public class MasterAddk
    {
        ...
        public List<MasterAddknormcombo> MasterAddknormcomboList { get; set; }
        //-----------------------------------------------------------------------------
        //END For normal combo
        //-----------------------------------------------------------------------------
        //public long MasterAddk_Type_ID { get; set; }
        public string MasterAddkTypeName { get; set; }
        public List<MasterAddkType> MasterAddkTypes { get; set; }   //for inner dropdown list within grid column

        public long Document_ID { get; set; }    //for Upload of a Document
        public string Risk_Level { get; set; }
        public long Risk_Level_ID { get; set; }
        public List<MasterAddkRiskLevelList> RiskTypess { get; set; }
    ...
    //----------------------------------------------------------------------------------------------------
    public class MasterAddknormcombo
    {
    ...
    /// </summary>
    public class MasterAddkRiskLevelList
    {
